  ...
  useEffect(() => {
    const handler = (e: KeyboardEvent) => {
      ...
      switch (e.key) {
        ...
        case "ArrowLeft":  e.preventDefault(); if (v) v.currentTime -= 10; break;
      ...
      // LG TV remote media keys
      switch (e.keyCode) {
        case 415: // Play
        case 179: // Play/Pause toggle
          e.preventDefault(); togglePlay(); break;
        case 19:  // Pause
          e.preventDefault(); if (v && !v.paused) v.pause(); break;
        case 413: // Stop
          e.preventDefault(); if (v) { v.pause(); v.currentTime = 0; } break;
        case 417: // Fast Forward
          e.preventDefault(); if (v) v.currentTime += 30; break;
        case 412: // Rewind
          e.preventDefault(); if (v) v.currentTime -= 30; break;
      }
    };
